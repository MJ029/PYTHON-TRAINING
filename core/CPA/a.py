...
if __name__ == "__main__":
    ...
    query = "SELECT COUNT(ID) as customers, AcceptedCmp1, MntMeatProducts, MntFishProducts, MntSweetProducts, MntGoldProds FROM customer_campaign GROUP BY AcceptedCmp1;"
