...
if __name__ == "__main__":
    ...
    query = "SELECT ID, Recency, martial_status, DENSE_RANK() OVER ( ORDER BY Recency DESC ) AS TOP_3_customers FROM customer_campaign WHERE martial_status = 'Single' LIMIT 3;"
