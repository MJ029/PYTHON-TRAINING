...
if __name__ == "__main__":
    ...
    query = "SELECT COUNT(ID) as customers, AcceptedCmp5, MntMeatProducts, MntFishProducts, MntSweetProducts, MntGoldProds FROM customer_campaign GROUP BY AcceptedCmp5;"
